  ...
  return (
    <div className="flex flex-col h-screen max-w-3xl mx-auto bg-background relative">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className={`absolute -top-1/2 -right-1/2 w-full h-full rounded-full blur-[120px] ${
          isRoast ? "bg-destructive/[0.06]" : "bg-primary/[0.05]"
        }`} />
        <div className="absolute -bottom-1/2 -left-1/2 w-full h-full bg-accent/[0.03] rounded-full blur-[120px]" />
      ...
      {hasMessages ? (
        <>
          <div className="flex-1 overflow-y-auto scrollbar-thin relative z-10">
            <div className="px-4 py-5 space-y-6 pb-2">
